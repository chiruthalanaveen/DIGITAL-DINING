...
const ROLE = 'kitchen'
const ROLE_LABEL = 'Kitchen'

export default function KitchenFaceLockLayout({ children }) {
    ...
    return (
      <main className="flex min-h-[100dvh] w-full items-center justify-center overflow-x-hidden bg-neutral-950 p-4 text-white">
        <div className="w-full max-w-sm rounded-[30px] border border-neutral-800 bg-neutral-900 p-6 shadow-2xl">
          <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-3xl bg-red-500/10 text-3xl">
            🍳
          </div>

          <p className="mt-5 text-center text-[10px] font-black uppercase tracking-[0.2em] text-red-400">
          ...
          <button
            ...
            disabled={busy}
            className="mt-5 w-full rounded-2xl bg-red-500 py-4 text-sm font-black text-white disabled:opacity-50"
          >
            {busy
              ? 'Checking Biometrics...'
              : `Enable ${biometryName}`}
    ...
    return (
      <main className="flex min-h-[100dvh] w-full items-center justify-center overflow-x-hidden bg-neutral-950 p-4 text-white">
        <div className="w-full max-w-sm rounded-[30px] border border-neutral-800 bg-neutral-900 p-6 text-center shadow-2xl">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-[28px] bg-red-500/10 text-4xl">
            🍳
          </div>
